...
<table class="table table-hover" style="width:1050px">
	...
	<tr>
		...
		<td rowspan="5"><img src="../${dto.resome_image}" class="img-rounded" style="margin-left: auto; margin-right: auto; display: block; width:150px; height:190px;"/>
		</td>	
	</tr>
	<tr>
	...
	<tr>
		...
		<input class="btn btn-default" type="button" style="width: 100px" value="우편번호 찾기" onclick="execDaumPostcode()">
	...
	<tr>
		<th> 병역사항 </th>
			<td>
				<select class="" style="width: 80px" name="army1">
					<option value="해당없음">해당없음</option>
					<option value="군필">군필</option>		
					<option value="미필">미필</option>
					<option value="면제">면제</option>
				</select>
				<input class="" type="text" style="width:125px" name="army2"> ~
				<input class="" type="text" style="width:125px" name="army3">
				
				<select class="" style="width: 80px" name="army4">
				...
				<select class="" style="width: 80px" name="army5">
				...
				<select class="" style="width: 80px" name="army6">
			...
			<td>	
				&nbsp;&nbsp;&nbsp;
				<input class="btn btn-default" type="file" name="imagefile" style="width:80px">
				<input class="btn btn-default" style="width:50px" type="reset" value="취소"></td>
	</tr>
...
<table class="table table-hover">
	...
	<table id="license_table" class="table table-hover">
		<tr>
			<th>자격증 이름</th>
			<th>발행일자</th>
			<th>발행일처</th>
...
<table class="table table-hover">
	...
	<tr>		
		...
		<td> <input class="" type="text" style="width:200px" name="school_name" maxlength="3">
			<select class="" style="width: 80px" name="school_name_kind">
