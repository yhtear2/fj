...
<script type="text/javascript">
	...
	var addedFormDiv = document.getElementById("addedFormDiv");
		...
		str += "<select class='input' style='width: 80px' name='school_college1'>";
		str += "<option value='입학'>입학</option>";
		str += "<option value='편입'>편입</option>";
		str += "</select>";
		str += "<select class='input' style='width: 80px' name='school_college2'>";
		...
		str += "</table>";
     	...
     	str += "     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
     	str += "	   &nbsp;&nbsp;&nbsp;&nbsp;";
     	str += "       <input  class='inputbutton'  type='button' value='추가' onclick='addForm()'>";
     	str += "       <input  class='inputbutton'  type='button' value='삭제' onclick='delForm()'>";
     	str += "   </td>";
     	str += "  </tr>";
	...
	function license_addform() {
		...
		str += "		<td colspan='2'> <input class='input' type='text' style='width:300px' name='license'>";
		str += "			<input class='inputbutton' type='submit' value='검색'>";
		str += "			<input class='inputbutton' type='button' value='추가' onclick='license_addform()'>";
		str += "			<input class='inputbutton' type='button' value='삭제' onclick='license_delForm()'>";
		str += "		</td>";
		str += "</tr>";
		str += "</table>";
	...
	function license_delForm() {
		...
		if (cnt > 1) {
			...
			if (confirm("삭제하시겠습니까?")) {
				addlicense.removeChild(addedDiv);
			}
		} else {
...
<table>
	<tr>
		<td><input class="input" type="text" name="resome_title" style="width: 650px" maxlength="40"></td>			
	</tr>
</table>
...
<table>
	...
	<tr>
		...
		<td style="width:620px"><input class="input" type="text" style="width: 250px" name="kor_name"></td>	
		
		<td rowspan="6"><img src="../${dto.resome_image}" style="margin-left: auto; margin-right: auto; display: block; width:150px; height:190px;"/>
		</td>	
	...
	<tr>
		...
		<th>이름(영문)</th>
		<td><input class="input" type="text" style="width: 250px" name="eng_name">
			</td>
	...
	<tr>
		...
		<th>주소</th>
		<td><input class="input" type="text" style="width: 120px" id="postcode" name="postcode">
		<input class="inputbutton" type="button" style="width: 100px" value="우편번호 찾기" onclick="execDaumPostcode()">
		<input class="input" type="text" style="width: 190px" name="address1" id="address1">&nbsp;
		<input class="input" type="text" style="width: 150px" name="address2" id="address2">
		</td>
	...
	<tr>
		<th>전화번호</th>
			<td><input class="input" type="text" style="width: 60px" name="tel1" maxlength="3"> - 
			    <input class="input" type="text" style="width: 65px" name="tel2" maxlength="4"> -
				<input class="input" type="text" style="width: 70px" name="tel3" maxlength="4"></td>
	</tr>

	<tr>
		<th>생년월일</th>
			<td><input class="input" type="text" name="birth" maxlength="12" style="width:200px"></td>
	</tr>
	
	<tr>
		<th> 병역사항 </th>
			<td>
				<select class="input" style="width: 80px" name="army1">
					<option value="해당없음">해당없음</option>
					<option value="군필">군필</option>		
					<option value="미필">미필</option>
					<option value="면제">면제</option>
				</select>
				<input class="input" type="text" style="width:125px" name="army2"> ~
				<input class="input" type="text" style="width:125px" name="army3">
				
				<select class="input" style="width: 80px" name="army4">
				...
				<select class="input" style="width: 80px" name="army5">
				...
				<select class="input" style="width: 80px" name="army6">
				...
				&nbsp; 미필,면제,기타사유 : 	<input class="input" type="text" style="width:260px" name="army7" maxlength="3">
			</td>
	</tr>
	...
	<tr>
		<th></th>
			...
			<td>	
				&nbsp;&nbsp;&nbsp;
				<input class="inputbutton" type="file" name="imagefile" style="width:80px">
				<input class="inputbutton" style="width:60px" type="reset" value="취소">
					</td>
		</tr>
...
<table>
	...
	<tr>
		<th style="width:89px">보유기술</th>
			<td colspan="2"> <input class="input" name="skill" id="skill" type="text" style="width:460px" name="year2">
				<input class="inputbutton" type="button" value="검색" onclick="conf_skill()">
			</td>
	</tr>		
	<tr>
		<th>희망연봉</th>
			<td><input class="input" type="text" name="want_salary" style="width:160px">만원단위로 숫자만 입력하세요. &nbsp; (ex:2500)
			</td>
	</tr>
</table>
	...
	<table>
		<tr>
			<th style="width:89px">자격증</th>
				<td colspan="2"> <input class="input" type="text" style="width:300px" name="license">
					<input class="inputbutton" type="button" value="검색" style="width:60px">
				    <input  class="inputbutton"  type="button" value="추가" style="width:60px" onclick="license_addform()">
					<input class="inputbutton" type="reset" value="삭제" style="width:60px" onclick=" license_delForm()">					
				</td>
		</tr>
		</table>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input  class="inputbutton"  type="submit" value="개인정보 저장하기" style="width:200px"></td>
...
<h5>고등학교</h5>
<form name="school_Form"  method="post" onload="addForm();" action="school_Pro.do">
...
<table>
	<tr>
		<th style="width:100px">재학기간</th>
			<td style="width: 520px">
				<input class="input" type="text" style="width:210px" name="school_start_date"> ~
				<input class="input" type="text" style="width:210px" name="school_last_date">
				
				<select class="input" style="width: 80px" name="school_college_high">
	...
	<tr>		
		<th>학교명</th>
		<td> <input class="input" type="text" style="width:200px" name="school_name" maxlength="3">
			<select class="input" style="width: 80px" name="school_name_kind">
...
<table>
	...
	<th></th>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 <input  class="inputbutton"  type="submit" value="학력사항 저장" style="width:200px"></td>
	</tr>
</table>
