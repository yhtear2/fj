...
function add_introduce(){
    ...
    if( cnt < 10 ){
	    ...
	    var html =	'<div style="margin-top:30px;"  id="standardID'+ cnt +'">'
	    		...
	    		+	'<div class="subject"><input type="button" value="변경" class="btn btn-default" name="modify" onclick="sub_name_modify('+cnt+')"'
	    		...
	    		+	'</div>'
	    		+	'<div> <textarea name="contents'+cnt+'" rows="13" cols="104"></textarea> </div>'
	    		+	'<div align="right">' 
