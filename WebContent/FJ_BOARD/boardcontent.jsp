                        ...
                        <li class="list-group-item note-item clearfix" id="note-1034847">
                            <form action="/content/update/1034847" method="post" data-id="1034847" class="note-update-form"><input type="hidden" name="_method" value="PUT" id="_method">
                                <div class="content-body panel-body pull-left">
                                    ...
                                    <div class="avatar avatar-medium clearfix "><a href="/user/info/40879" class="avatar-photo"><img src="//www.gravatar.com/avatar/ea033f92e21318820a45c9bb5ca83403?d=identicon&amp;s=40"></a> <div class="avatar-info"><a class="nickname" href="/user/info/40879">JQuery</a> <div class="activity"><span class="fa fa-flash"></span> 10</div><div class="date-created timeago" title="2016-02-24 13:47:24.0">2분 전</div></div></div>
                                    <fieldset class="form">
							...
							<a href="javascript://" class="note-vote-btn" role="button"
								...
								data-toggle="tooltip" data-placement="left" title=""
								data-original-title="좋아요"></i></a>
							<div id="content-vote-count-1034847" class="content-count">0</div>
						</div>
                                </div>
                            ...
                            <form action="/content/delete/1034847" method="post" id="note-delete-form-1034847"><input type="hidden" name="_method" value="DELETE" id="_method">
                            </form>
                        </li>
                    
                        <li class="list-group-item note-item clearfix" id="note-1034849">
                            <form action="/content/update/1034849" method="post" data-id="1034849" class="note-update-form"><input type="hidden" name="_method" value="PUT" id="_method">
                                <div class="content-body panel-body pull-left">
                                    

                                    <div class="avatar avatar-medium clearfix "><a href="/user/info/40879" class="avatar-photo"><img src="//www.gravatar.com/avatar/ea033f92e21318820a45c9bb5ca83403?d=identicon&amp;s=40"></a> <div class="avatar-info"><a class="nickname" href="/user/info/40879">JQuery</a> <div class="activity"><span class="fa fa-flash"></span> 10</div><div class="date-created timeago" title="2016-02-24 13:48:04.0">1분 전</div></div></div>
                                    <fieldset class="form">
                                        <article id="note-text-1034849" class="list-group-item-text note-text">
                                ...
                                <div class="content-function pull-right text-center">
                                    <div class="content-function-group">
                                        <a href="javascript://" class="note-vote-btn" role="button" data-type="vote" data-eval="false" data-id="1034849"><i id="note-vote-1034849" class="fa fa-thumbs-up note-vote" data-toggle="tooltip" data-placement="left" title="" data-original-title="좋아요"></i></a><div id="content-vote-count-1034849" class="content-count">0</div>
                                    </div>
                                </div>

                                 
                                <div id="content-function-cog-1034849" class="content-function-cog">
                                    <div class="dropdown">
                                        <a href="javascript://" data-toggle="dropdown"><i class="fa fa-cog" data-toggle="tooltip" data-placement="left" title="" data-original-title="게시물 설정"></i></a>
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="javascript://" class="note-edit-btn" data-id="1034849"><i class="fa fa-edit fa-fw"></i> 수정</a></li>
                                            <li><a href="javascript://" class="note-delete-btn" data-id="1034849"><i class="fa fa-trash-o fa-fw"></i> 삭제</a></li>
                                        </ul>
                                    </div>
                                    <div class="buttons" style="display: none;">
                                        <p><a href="javascript://" class="btn btn-default btn-wide note-edit-cancel-btn">취소</a></p>
                            ...
                            <form action="/content/delete/1034849" method="post" id="note-delete-form-1034849"><input type="hidden" name="_method" value="DELETE" id="_method">
                            </form>
                        </li>
                    
                    <li class="list-group-item note-form clearfix">
                        
                            <form action="/article/addNote/314044" method="post" class="note-create-form">
