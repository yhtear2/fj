...
@Controller
public class MessgaeContentHandler implements Commandhandler {
	
	@Resource(name="messageDao")
	private MessageDao dao;

	@RequestMapping("/messgaeContent")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		...
		dao.addReadContent(message_num);
		MessageDataBean dto = dao.getContent(message_num);
		
		map.put("pageNum", pageNum);
		map.put("dto", dto);
		map.put("page", "/FJ_MESSAGE/messgaeContent");
